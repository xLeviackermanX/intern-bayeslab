...
def test_input_data():
    dataset = PreprocessingFunc.input_data(data_path)
...
def test_string_to_int():
    smi_int = PreprocessingFunc.string_to_int(smi.split(' '),50,input_vocab)
...
def test_int_to_string():
    int_smi = PreprocessingFunc.int_to_string(smi_int,inv_vocab)
