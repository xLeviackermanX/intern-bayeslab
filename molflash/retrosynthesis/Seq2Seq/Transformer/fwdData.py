...
class React2ProdDataModule(pl.LightningDataModule):
    ...
    def prepare_data(self) -> None:
        self.data, self.product_vocab_size, self.reactant_vocab_size,  self.product_pad_index, self.reactant_pad_index = PreprocessingFunc.fwd_input_data(self.filePath)
