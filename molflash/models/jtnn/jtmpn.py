...
from molflash.models.jtnn.nnutils import create_var, index_select_ND
from molflash.models.jtnn.chemutils import get_mol
import rdkit.Chem as Chem

ELEM_LIST = ['C', 'N', 'O', 'S', 'F', 'Si', 'P', 'Cl', 'Br', 'Mg', 'Na', 'Ca', 'Fe', 'Al', 'I', 'B', 'K',
             'Se', 'Zn', 'H', 'Cu', 'Mn', 'unknown']
