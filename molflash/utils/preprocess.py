...
class PreprocessingFunc:
    ...
    def input_data(cls,data_path):
        ...
        with open('molflash/retrosynthesis/Seq2Seq/Transformer/reactants_vocab.json', 'w') as fr:
            json.dump(reactants_vocab, fr)
        with open('molflash/retrosynthesis/Seq2Seq/Transformer/products_vocab.json', 'w') as fp:
